    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, helperFunctions_1.fetchGraphQL)(schemas_1.CREATE_CUSTOMTABLE, {
                        name: input.name,
                        user_id: user_id
                    })];
            case 1:
                ...
                return [4 /*yield*/, input.fields.forEach(function (field) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, helperFunctions_1.fetchGraphQL)(schemas_1.CREATE_CTFIELD, {
                                        label: field.label,
                                        type: field.type,
            ...
            case 2:
                ...
                return [4 /*yield*/, fetch('https://data-logger.hasura.app/v1/query', {
                        method: 'POST',
                        body: JSON.stringify((0, helperFunctions_1.createTableBody)(input, user_id)),
                        headers: {
